...
{
    // In a real engine, use a Resource Manager here
    if (!this->textures["PLAYER_IDLE"].loadFromFile("Resources/Images/Sprites/Player/test.png"))
    {
        throw std::runtime_error("ERROR::GAME_STATE::COULD_NOT_LOAD_PLAYER_IDLE_TEXTURE");
    }
}
...
{
    // Keyboard Input mapped to Movement
